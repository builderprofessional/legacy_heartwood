...
<script type="text/javascript" src="<?= $this->getFileHref("dragdrop.js") ?>"></script>
    ...
    <div style="margin-top:20px; text-align:center; ">
        ...
        <div style="width:100%; text-align:center; font-size:17px; font-weight:900; color:#CC3344; background-color:#444; padding:4px; ">
            Photos must be sized to <?= $this->slideshow->config_width ?> pixels wide by <?= $this->slideshow->config_height ?> pixels high!
        </div>
