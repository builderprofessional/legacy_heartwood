<?= $this->fetch( $this->googleMap->getGoogleMapJsTemplateHref() ) ?>
<link rel="stylesheet" type="text/css" media="screen" href="<?= $this->getFileHref("bseCommunities.css") ?>" />
<table class="commMapDisplay" cellspacing=0 cellpadding=0 border=0 style="table-layout:auto; ">
    <tr>
        <td style="vertical-align:top; ">
            <div style="text-align:center;border-style:solid; ">
                <div class="commMapLink"><a class="commMapLink" href="javascript:map.setCenter(new GLatLng(<?=$this->googleMap->mapCenter?>));">Re-Center</a> | <a href="javascript:<?= $this->googleMap->resetCode?>">Reset Map</a> | <a href="javascript:map.closeInfoWindow();">Close windows</a></div>
    ...
    { ?>
        <td class="confInfo" style="padding-left:15px; vertical-align:top; ">
            ...
            <div style="margin-bottom:20px; ">
                <input id="shopCheck" type='checkbox' name='commonSearch' value='schools' onclick="buttonOnclick('commonSearch');" /> <span style='cursor:pointer; ' onclick="document.getElementById('shopCheck').checked = !document.getElementById('shopCheck').checked; buttonOnclick('commonSearch');">Schools</span><br />
                <input id="grocCheck" type='checkbox' name='commonSearch' value='churches' onclick="buttonOnclick('commonSearch');" /> <span style='cursor:pointer; ' onclick="document.getElementById('grocCheck').checked = !document.getElementById('grocCheck').checked; buttonOnclick('commonSearch');">Churches</span><br />
                <input id="restCheck" type='checkbox' name='commonSearch' value='banks' onclick="buttonOnclick('commonSearch');" /> <span style='cursor:pointer; ' onclick="document.getElementById('restCheck').checked = !document.getElementById('restCheck').checked; buttonOnclick('commonSearch');">Banks</span><br />
                <input id="pizaCheck" type='checkbox' name='commonSearch' value='shopping' onclick="buttonOnclick('commonSearch');" /> <span style='cursor:pointer; ' onclick="document.getElementById('pizaCheck').checked = !document.getElementById('pizaCheck').checked; buttonOnclick('commonSearch');">Shopping</span><br />
                <input id="chnsCheck" type='checkbox' name='commonSearch' value='restaurants' onclick="buttonOnclick('commonSearch');" /> <span style='cursor:pointer; ' onclick="document.getElementById('chnsCheck').checked = !document.getElementById('chnsCheck').checked; buttonOnclick('commonSearch');">Restaurants</span><br />
                <input id="stekCheck" type='checkbox' name='commonSearch' value='grocery' onclick="buttonOnclick('commonSearch');" /> <span style='cursor:pointer; ' onclick="document.getElementById('stekCheck').checked = !document.getElementById('stekCheck').checked; buttonOnclick('commonSearch');">Groceries Stores</span><br />
...
<?php
    ...
    else if( $this->googleMap->hideCommList != true )
    {
        echo "<td class=\"confInfo\" style=\"padding-left:15px; vertical-align:top; width:30%; \">".$this->fetch($this->googleMap->getCommunitiesListTemplateHref())."</td>";
    }
?>
    </tr>
</table>
