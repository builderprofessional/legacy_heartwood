...
//                this._mapBase.style.display = "block";
	...
	setBG: function(el, c) {
        ...
        this.raiseEvent(this.bgChanged);
    ...
    raiseEvent: function(name)
    {
        ...
        if(vEvent)
        {
            switch (typeof vEvent)
            {
                case "function":
                    return name(); // can't use variable or 'this' will be lost
                    break;
            case "object":
                if (vEvent["raiseEvent"])
                {
                    return name.raiseEvent(name);
                }
                break;
            case "string":
                this.fnEvent = new Function(name);
                return this.fnEvent();
                break;
            case "undefined":
                break;
