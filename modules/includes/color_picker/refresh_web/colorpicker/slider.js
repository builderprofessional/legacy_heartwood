...
Refresh.Web.DefaultSliderSettings = {
	...
	yMinValue: 0,
	yMaxValue: 100,
	arrowImage: 'modules/includes/refresh_web/colorpicker/images/rangearrows.gif'
}
...
Refresh.Web.Slider.prototype = {
	...
	initialize: function(id, settings) {
		...
		this._arrow.style.left = '0px';
                this._parentElement = document.getElementById('containerBody');
		document.body.appendChild(this._arrow);
                //this._bar.parentNode.appendChild(this._arrow);
...
//                Event.observe( this._parentElement, 'onscroll', this.setPositioningVariables.bindAsEventListener(this));
	},
	...
	setPositioningVariables: function() {
		...
		// BAR
//alert("Entered 'setPositionVariables': scrollTop = "+this._parentElement.scrollTop);
