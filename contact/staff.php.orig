...
// Get required variables
    $bse->contactPage = $bse->getModule("bseContactPage");
    $bse->contactPage->setPageId(1);
    ...
    $_REQUEST['type'] = "warranty";    // This is here as a workaround to make the staff page display a link to the contact form instead of the warranty form
